	...
	<div style="position:relative; float:right;" class="dropdown">
	  	...
	  	<ul class="dropdown-menu">
	    	<li><a href="http://gestion-atit-guayana.corpoelec.com.ve/mod/insumo/calc/exportar.php?valor=<?php echo $ano; ?>&fuente=1&tip=mttr_servicio"><span class="icon-file-openoffice"></span> CALC</a></li>
	    	<li><a href="http://gestion-atit-guayana.corpoelec.com.ve/mod/insumo/pdf/exportar.php?valor=<?php echo $ano; ?>&fuente=1&tip=mttr_servicio"><span class="icon-file-pdf"></span> PDF</a></li>
	  	</ul>
	</div>
	<br /><br />
	<?php } else { $ano = $_GET["valor"]; } ?>
	<form name="tabla">
		<input name="titulo" type="hidden" value="Gráfica MTTR Fallas de Servicios">
		<input name="parametro2" type="hidden" value="MTTR (Hrs)">
		<input name="parametro1" type="hidden" value="N° Fallas">
	<h3>Indicador MTTR Fallas de Servicios</h3>
	<br />
